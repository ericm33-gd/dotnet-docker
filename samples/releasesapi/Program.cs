...
long managedMemoryMB = ((managedMemory / 1024) / 1024); // Convert to MB

Console.WriteLine(DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") + " Managed Memory Used (Raw): " + managedMemory);
Console.WriteLine(DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") + " Managed Memory Used (MB): " + managedMemoryMB);
